...
#ifndef _TEST_BLACKBOX_REQREPHELLOWORLDSERVICEFACTORY_HPP_
#define _TEST_BLACKBOX_REQREPHELLOWORLDSERVICEFACTORY_HPP_
...
class ReqRepHelloWorldServiceFactory : public eprosima::fastdds::dds::rpc::IServiceFactory
{
...
public:
    ...
    // Create a participant with specific configuration for this service
    // The user is responsible for deleting the participant manually
    eprosima::fastdds::dds::DomainParticipant* create_service_participant();
...
protected:
    ...
    {   
        try
        {
            return new ReqRepHelloWorldService(service_name, service_type_name, participant);
        }
        catch (const std::exception& e)
        {
            std::cout << "Error creating ReqRepHelloWorldService instance: " << e.what() << std::endl;
            return nullptr;
        }
    }
...
#endif // _TEST_BLACKBOX_REQREPHELLOWORLDSERVICEFACTORY_HPP_