...
#ifndef FASTDDS_DDS_RPC__REQUESTREPLYCONTENTFILTERFACTORY_HPP
#define FASTDDS_DDS_RPC__REQUESTREPLYCONTENTFILTERFACTORY_HPP
...
public:
            ...
            IContentFilter*& filter_instance) override
    {
        ...
        if (0 != strcmp(filter_class_name, "REQUEST_REPLY_CONTENT_FILTER"))
        {
...
#endif // FASTDDS_DDS_RPC__REQUESTREPLYCONTENTFILTERFACTORY_HPP