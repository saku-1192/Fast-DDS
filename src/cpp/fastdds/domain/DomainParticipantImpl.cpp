...
#include <fastdds/dds/rpc/RequestReplyContentFilterFactory.hpp>
        ...
        const RequesterQos& qos)
{
    ...
    params.qos(qos);
    rpc::Requester* requester = service->create_requester(params);
        ...
        const ReplierQos& qos)
{
    ...
    params.qos(qos);
    rpc::Replier* replier = service->create_replier(params);
